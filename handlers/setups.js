    ...
    function getAll(client, guild) {    
        const embed = new MessageEmbed()
            ...
            .setTitle('Help Menu - THANKS FOR INVITING ME!')
                ...
                >>> <@840025174651830333> \`Truchorko#5566\` [\`Website\`](https://musicium.eu) [\`INVITE\`](https://discord.com/oauth2/authorize?client_id=789845410998779904&permissions=8&scope=bot%20applications.commands)
                `)
