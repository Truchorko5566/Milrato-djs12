...
//client.api.applications(client.user.id).guilds('guild id').commands.post({data: {     für einen server VVVV ist für mehr als 1 server
	...
	let totalMembers = client.guilds.cache.reduce((c, g) => c + g.memberCount, 0);
            ...
            const infoembed = new Discord.MessageEmbed()
                ...
                .addFields(
                    ...
                    },
                    {
                        ...
                        value: `**\`Truchorko#5566\` <@840025174651830333>**`,
                        inline: true,
                    },
                )
                .addField("\u200b", `
            ...
            `)
                .addField("***BOT BY:***", `
            >>> <@840025174651830333> \`Truchorko#5566\` [\`Website\`](https://musicium.eu)
            `)
                .addField("***SUPPORT:***", `
            ...
            .setTitle(`Help Menu\nPrefix: \`${prefix}\``)
                ...
                *more coming soon*
                ...
                >>> <@840025174651830333> \`Truchorko#5566\` [\`Website\`](https://musicium.eu) [\`INVITE\`](https://discord.com/api/oauth2/authorize?client_id=789845410998779904&permissions=8&scope=bot%20applications.commands)
                `)
