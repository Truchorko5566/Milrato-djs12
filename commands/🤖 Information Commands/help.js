...
async function getAll(client, message) {
    const embed = new MessageEmbed()
        ...
        >>> <@840025174651830333> \`Truchorko#5566\` [\`Website\`](https://musicium.eu) [\`INVITE\`](https://discord.com/api/oauth2/authorize?client_id=798583657592782868&permissions=8&scope=bot%20applications.commands)
        `)
